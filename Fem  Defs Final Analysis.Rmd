...
getwd()
setwd()
output_dir <- "/Users/sarahsowell/Desktop/Final Fem-Defs Graphs"
```
...
theme_minimal()+
ylim(0,80)+
    scale_x_discrete(labels = c("Manager", "Victim", "Bottom", "Associate", "Partner", "CEO", "NEI")) +
...
ggsave(file.path(output_dir, "agemissing.png"), plot = plot1, width = 6, height = 4, dpi = 300)
...
ggsave(file.path(output_dir, "raceissing.png"), plot = plot2, width = 6, height = 4, dpi = 300)
...
ggsave(file.path(output_dir, "recruit(figure1).png"), plot = plot3, width = 6, height = 4, dpi = 300)
...
ggsave(file.path(output_dir, "Figure 3.png"), plot = plot4, width = 6, height = 4, dpi = 300)
...
a <- a + 
  annotate("text", x = 1, y = 60, label = "55", family = "Times", size = 4) +
  annotate("text", x = 2, y = 164, label = "159", family = "Times", size = 4) +
  annotate("text", x = 3, y = 42, label = "37", family = "Times", size = 4) +
  annotate("text", x = 4, y = 114, label = "109", family = "Times", size = 4) +
  annotate("text", x = 5, y = 44, label = "39", family = "Times", size = 4)
...
ggsave(file.path(output_dir, "hist_defs(figure4).png"), plot = plot5, width = 6, height = 4, dpi = 300)
...
ggsave(file.path(output_dir, "avg_admin(figure5).png"), plot = plot6, width = 6, height = 4, dpi = 300)
...
ggsave(file.path(output_dir, "traff_type(figure6).png"), plot = plot7, width = 6, height = 4, dpi = 300)
...
geom_bar(stat= "identity", fill="#A5E3ED")+
ylim(0,40)+
#scale_fill_manual(values=(c( "#1957CD", "#0F347B", "#46ADE3", "#1895A7","#A5E3ED")))+
ylab("Age at Arrest")+
xlab("")+
...
ggsave(file.path(output_dir, "age_typ(figure7a).png"), plot = plot8, width = 6, height = 4, dpi = 300)
...
ggsave(file.path(output_dir, "age_typ_box(figure7b).png"), plot = plot9, width = 6, height = 4, dpi = 300)
...
ggsave(file.path(output_dir, "race(figure8).png"), plot = plot10, width = 6, height = 4, dpi = 300)
...
geom_bar(stat= "identity",fill= "#1895A7")+
ylim(0,3)+
...
ggsave(file.path(output_dir, "foreignat(figure8).png"), plot = plot11, width = 6, height = 4, dpi = 300)
...
ggsave(file.path(output_dir, "victimage(figure10).png"), plot = plot13, width = 6, height = 4, dpi = 300)
...
ggsave(file.path(output_dir, "time_appendix.png"), plot = plot14, width = 6, height = 4, dpi = 300)
